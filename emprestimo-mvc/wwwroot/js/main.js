$(document).ready(function () {
    ...
    if (btnEntradaEmprestimo) {
        btnEntradaEmprestimo.addEventListener("click", function () {
            ...
            window.location.href = "ConfirmarEmprestimo";
        });
    }
    ...
    //Sistema de busca dos clientes cadastrados no sistema para definir a um novo emprestimo

    $("#nomeNovoEmprestimo").autocomplete({
        source: 'api/emprestimoapi/search'
    });
});
